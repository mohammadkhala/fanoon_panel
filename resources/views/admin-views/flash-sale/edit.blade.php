...
@section('content')
    <div class="content container-fluid">
        <div class="mb-3 d-flex align-items-center justify-content-between flex-wrap gap-2">
            ...
            <button type="button" class="btn btn-outline-primary btn-sm" data-toggle="modal" data-target="#flashSaleEditInstructionsModal">
                <i class="tio-book-outlined"></i> {{ translate('help_flash_sale_edit_btn') }}
            </button>
        </div>

        @include('admin-views.partials._help-instructions-modal', ['modalId' => 'flashSaleEditInstructionsModal', 'titleKey' => 'help_flash_sale_edit_title', 'pageKey' => 'help_flash_sale_edit_page'])
