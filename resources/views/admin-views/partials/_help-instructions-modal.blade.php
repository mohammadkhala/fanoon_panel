{{-- Modal تعليمات — استخدم مع: @include('admin-views.partials._help-instructions-modal', ['modalId' => 'xxx', 'titleKey' => 'help_xxx_title', 'pageKey' => 'help_xxx_page']) --}}
        ...
        <div class="modal-content">
            <div class="modal-header help-instructions-modal-header">
                ...
                <h5 class="modal-title" id="{{ $modalId }}Label">
                    <i class="tio-book-outlined me-1"></i> {{ translate($titleKey) }}
                </h5>
            </div>
