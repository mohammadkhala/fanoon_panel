                ...
                <form action="{{ route('admin.business-settings.update-apple-login-setup') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body text-left">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label mb-0">{{translate('service_file')}} {{ $appleLoginService['service_file']?translate('(Already Exists)'):'' }}</label>
                                    <p class="fs-14 text-muted mb-2 mt-0">{{ translate('File format')}} - .p8 |{{ translate('maximum size') }} - {{ readableUploadMaxFileSize('file') }}</p>
                                    <input type="file" accept=".p8"
                                           data-maxFileSize="{{ readableUploadMaxFileSize('file') }}"
                                           class="form-control" name="service_file"
