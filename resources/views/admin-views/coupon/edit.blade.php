...
@section('content')
    <div class="content container-fluid">
        <div class="mb-3 d-flex align-items-center justify-content-between flex-wrap gap-2">
            ...
            <button type="button" class="btn btn-outline-primary btn-sm" data-toggle="modal" data-target="#couponEditInstructionsModal">
                <i class="tio-book-outlined"></i> {{ translate('help_coupon_edit_btn') }}
            </button>
        </div>

        @include('admin-views.partials._help-instructions-modal', ['modalId' => 'couponEditInstructionsModal', 'titleKey' => 'help_coupon_edit_title', 'pageKey' => 'help_coupon_edit_page'])
