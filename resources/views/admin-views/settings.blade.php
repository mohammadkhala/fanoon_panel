                ...
                <form action="{{route('admin.settings')}}" method="post" enctype="multipart/form-data"
                    ...
                    <div class="card mb-3 mb-lg-5" id="generalDiv">
                        <div class="profile-cover">
                            <div class="profile-cover-img-wrapper" style="background-image: url('{{ asset('assets/admin/img/profile-cover-baitpait.jpg') }}'); background-size: cover; background-position: center;"></div>
                        </div>
