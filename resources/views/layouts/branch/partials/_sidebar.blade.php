                                ...
                                <li class="nav-item {{Request::is('branch/orders/list/pending')?'active':''}}">
                                    <a class="nav-link " href="{{route('branch.orders.list',['pending'])}}" title="">
                                        ...
                                        <span class="text-truncate">
                                            {{translate('pending')}}
                                            <span class="badge badge-soft-info badge-pill ml-1">
                                                {{\App\Models\Order::notPos()->where(['order_status'=>'pending','branch_id'=>auth('branch')->id()])->count()}}
                                            </span>
                                        </span>
                                    </a>
                                </li>
                                    ...
                                    <a class="nav-link " href="{{route('branch.orders.list',['confirmed'])}}" title="">
                                        ...
                                        <span class="text-truncate">
                                            {{translate('confirmed')}}
                                                ...
                                                {{\App\Models\Order::notPos()->where(['order_status'=>'confirmed','branch_id'=>auth('branch')->id()])->count()}}
                                            </span>
                                        </span>
                                    </a>
                                </li>
                                    ...
                                    <a class="nav-link " href="{{route('branch.orders.list',['processing'])}}" title="">
                                        ...
                                        <span class="text-truncate">
                                            {{translate('processing')}}
                                                ...
                                                {{\App\Models\Order::notPos()->where(['order_status'=>'processing','branch_id'=>auth('branch')->id()])->count()}}
                                            </span>
                                        </span>
                                    </a>
                                </li>
                                       ...
                                       title="">
                                        ...
                                        <span class="text-truncate">
                                            {{translate('out_for_delivery')}}
                                                <span class="badge badge-soft-warning badge-pill ml-1">
                                                {{\App\Models\Order::notPos()->where(['order_status'=>'out_for_delivery','branch_id'=>auth('branch')->id()])->count()}}
                                            </span>
                                        </span>
                                    </a>
                                </li>
                                    ...
                                    <a class="nav-link " href="{{route('branch.orders.list',['returned'])}}" title="">
                                        ...
                                        <span class="text-truncate">
                                            {{translate('returned')}}
                                                ...
                                                {{\App\Models\Order::notPos()->where(['order_status'=>'returned','branch_id'=>auth('branch')->id()])->count()}}
                                            </span>
                                        </span>
                                    </a>
                                </li>
                                <li class="nav-item {{Request::is('branch/orders/list/failed')?'active':''}}">
                                    <a class="nav-link " href="{{route('branch.orders.list',['failed'])}}" title="">
                                        ...
                                        <span class="text-truncate">
                                            {{translate('failed')}}
                                            <span class="badge badge-soft-danger badge-pill ml-1">
                                                {{\App\Models\Order::notPos()->where(['order_status'=>'failed','branch_id'=>auth('branch')->id()])->count()}}
                                            </span>
                                        </span>
                                    </a>
                                </li>
                                    ...
                                    <a class="nav-link " href="{{route('branch.orders.list',['canceled'])}}" title="">
                                        ...
                                        <span class="text-truncate">
                                            {{translate('canceled')}}
                                                ...
                                                {{\App\Models\Order::notPos()->where(['order_status'=>'canceled','branch_id'=>auth('branch')->id()])->count()}}
                                            </span>
                                        </span>
                                    </a>
                                </li>
