...
<head>
    ...
    <title>{{ translate('Error 500') }} | {{ Helpers::get_business_settings('store_name') ?? Helpers::get_business_settings('restaurant_name') }}</title>
    @php
        $iconSetting = \App\Models\BusinessSetting::where(['key' => 'fav_icon'])->first();
        $icon = optional($iconSetting)->value;
...
<div class="footer text-center">
    <ul class="list-inline list-separator">
        <li class="list-inline-item">
            <a class="list-separator-link" target="_blank" href="<?php echo url('/') ?>">{{ Helpers::get_business_settings('store_name') ?? Helpers::get_business_settings('restaurant_name') }} {{ translate('Support') }}</a>
