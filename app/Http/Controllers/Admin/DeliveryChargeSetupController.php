...
class DeliveryChargeSetupController extends Controller
{
    ...
    public function changeDeliveryChargeType(Request $request): JsonResponse
    {
        ...
        if ($status) {
            if ($request['delivery_charge_type'] == 'distance'){
                return response()->json(['status' => false, 'error' => translate('Map is disabled. Use Area/Zip code for delivery charge.')], 200);
            }
            ...
            if ($newDeliveryChargeType == 'distance'){
                return response()->json(['status' => false, 'error' => translate('Map is disabled. Use Area/Zip code for delivery charge.')], 200);
            }
