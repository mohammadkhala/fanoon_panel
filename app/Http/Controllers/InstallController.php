...
class InstallController extends Controller
{
    ...
    public function system_settings(Request $request)
    {
        ...
        // يدعم restaurant_name (من ملفات التثبيت) و store_name (بعد migration)
        DB::table('business_settings')->whereIn('key', ['store_name', 'restaurant_name'])->update(['value' => $request['web_name']]);
